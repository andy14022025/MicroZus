...
HD_PWD='C:/FPGA/MicroZus/pl_iic/pl_iic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_iic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pl_iic.tcl -notrace

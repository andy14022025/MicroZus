...
HD_PWD='C:/FPGA/MicroZus/pl_iic_debug/pl_iic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_iic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pl_iic.tcl

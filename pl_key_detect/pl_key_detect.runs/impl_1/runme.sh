...
HD_PWD='C:/FPGA/pl_key_detect/pl_key_detect.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_key_detect.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pl_key_detect.tcl -notrace

...
HD_PWD='C:/FPGA/pl_key_detect/pl_key_detect.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_key_detect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pl_key_detect.tcl
